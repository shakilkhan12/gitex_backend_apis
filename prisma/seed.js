...
async function main() {
  ...
  for (const role of rolesList) {
    await prisma.users_permissions.create({
      data: {
        ...
        offices_update: ["Super Admin", "Office Manager"].includes(
          role.role_name
        ),
        parks_view: [
          "Super Admin",
        ...
        system_report_view: ["Super Admin", "Operations Manager"].includes(
          role.role_name
        ),
        alerts_view: true,
        ...
        office_attendance_add: ["Super Admin", "Office Manager"].includes(
          role.role_name
        ),
        office_attendance_update: ["Super Admin", "Office Manager"].includes(
          role.role_name
        ),
        ...
        office_footfall_add: ["Super Admin", "Office Manager"].includes(
          role.role_name
        ),
        office_footfall_update: ["Super Admin", "Office Manager"].includes(
          role.role_name
        ),
        ...
        office_sentimental_add: ["Super Admin", "Office Manager"].includes(
          role.role_name
        ),
        office_sentimental_update: ["Super Admin", "Office Manager"].includes(
          role.role_name
        ),
        ...
        park_attendance_add: ["Super Admin", "Park Manager"].includes(
          role.role_name
        ),
        park_attendance_update: ["Super Admin", "Park Manager"].includes(
          role.role_name
        ),
        park_footfall_view: [
          "Super Admin",
        ...
        park_footfall_add: ["Super Admin", "Park Manager"].includes(
          role.role_name
        ),
        park_footfall_update: ["Super Admin", "Park Manager"].includes(
          role.role_name
        ),
        ...
        park_sentimental_add: ["Super Admin", "Park Manager"].includes(
          role.role_name
        ),
        park_sentimental_update: ["Super Admin", "Park Manager"].includes(
          role.role_name
        ),
    ...
    data: [
      {
        ...
        image:
          "https://images.freepik.com/free-photo/beautiful-park-with-green-grass-trees_181624-16041.jpg",
        latitude: 25.2048,
        longitude: 55.2708,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/green-park-with-trees-grass_181624-32951.jpg",
        latitude: 25.2285,
        longitude: 55.3094,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/tropical-beach-with-palm-trees_181624-46234.jpg",
        latitude: 25.2285,
        longitude: 55.2394,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/beautiful-landscape-with-lake-mountains_181624-25847.jpg",
        latitude: 25.2454,
        longitude: 55.3261,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/beautiful-beach-with-clear-blue-water_181624-45821.jpg",
        latitude: 25.2944,
        longitude: 55.3364,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/forest-landscape-with-trees_181624-51472.jpg",
        latitude: 25.1579,
        longitude: 55.4214,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/green-field-with-trees-blue-sky_181624-18294.jpg",
        latitude: 25.2686,
        longitude: 55.4347,
      },
    ],
    ...
    data: [
      {
        ...
        image:
          "https://images.freepik.com/free-photo/modern-office-building-with-glass-facade_181624-31547.jpg",
        latitude: 25.2697,
        longitude: 55.3095,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/corporate-building-exterior_181624-42851.jpg",
        latitude: 25.2709,
        longitude: 55.3095,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/modern-business-building_181624-29841.jpg",
        latitude: 25.2582,
        longitude: 55.2962,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/office-building-with-modern-architecture_181624-35742.jpg",
        latitude: 25.2285,
        longitude: 55.2394,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/government-building-facade_181624-28541.jpg",
        latitude: 25.2369,
        longitude: 55.3011,
      },
      {
        ...
        image:
          "https://images.freepik.com/free-photo/contemporary-office-building_181624-39574.jpg",
        latitude: 25.2522,
        longitude: 55.3448,
      },
    ],
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.live_stream_favourites.create({
      data: {
        ...
        office_camera_Id:
          i >= 3 ? officeCameras[i % officeCameras.length].Id : null,
      },
    });
  }
  ...
  for (let i = 0; i < 7; i++) {
    ...
    const exitTime = new Date(
      entryTime.getTime() + Math.random() * 8 * 60 * 60 * 1000
    );
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.parks_sentiment_analysis.create({
      data: {
        ...
        person_image: `https://images.freepik.com/free-photo/portrait-person-${
          i % 2 === 0 ? "man" : "woman"
        }_181624-${20000 + i}.jpg`,
        gender: i % 2 === 0 ? "Male" : "Female",
        check_in_image: `https://images.freepik.com/free-photo/person-entering-park_181624-${
          30000 + i
        }.jpg`,
        ...
        check_out_sentiment:
          Math.random() > 0.5 ? sentiments[(i + 1) % sentiments.length] : null,
        exit_camera_Id:
          Math.random() > 0.5 ? parkCameras[i % parkCameras.length].Id : null,
      },
    });
  }
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.offices_sentiment_analysis.create({
      data: {
        ...
        person_image: `https://images.freepik.com/free-photo/business-person-portrait_181624-${
          40000 + i
        }.jpg`,
        gender: i % 2 === 0 ? "Male" : "Female",
        check_in_image: `https://images.freepik.com/free-photo/person-entering-office_181624-${
          50000 + i
        }.jpg`,
        ...
        exit_camera_Id:
          Math.random() > 0.5
            ? officeCameras[i % officeCameras.length].Id
            : null,
      },
    });
  }
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.parks_behaviour_alerts.create({
      data: {
        ...
        description: `Alert for ${
          behaviours[i % behaviours.length]
        } detected in ${parksList[i % parksList.length].park_english_name}`,
        detected_behaviour: behaviours[i % behaviours.length],
        is_employee: Math.random() > 0.7,
        snap_shot: `https://images.freepik.com/free-photo/security-alert-${
          (i % 3) + 1
        }_181624-${60000 + i}.jpg`,
      },
    });
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.parks_intrusion_detection.create({
      data: {
        park_Id: parksList[i % parksList.length].Id,
        location: `Zone ${i + 1} - ${
          parksList[i % parksList.length].park_english_name
        }`,
        camera_Id: parkCameras[i % parkCameras.length].Id,
        occurrence_date: new Date(),
        occurrence_time: new Date(),
        snap_shot: `https://images.freepik.com/free-photo/intrusion-detection-${
          (i % 3) + 1
        }_181624-${70000 + i}.jpg`,
        detection_Id: `INTRU_${Date.now()}_${i}`,
        detection_date: new Date(),
        detection_time: new Date(),
        description: `Unauthorized access detected in restricted area of ${
          parksList[i % parksList.length].park_english_name
        }`,
        is_employee: Math.random() > 0.8,
        current_status:
          i % 3 === 0 ? "resolved" : i % 3 === 1 ? "investigating" : "pending",
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.parks_smoking_detection.create({
      data: {
        ...
        occurrence_date: new Date(),
        occurrence_time: new Date(),
        snap_shot: `https://images.freepik.com/free-photo/smoking-detection-${
          (i % 3) + 1
        }_181624-${80000 + i}.jpg`,
        detection_Id: `SMOKE_${Date.now()}_${i}`,
        detection_date: new Date(),
        detection_time: new Date(),
        description: `Smoking activity detected in non-smoking area of ${
          parksList[i % parksList.length].park_english_name
        }`,
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.parks_landscaping.create({
      data: {
        ...
        snap_shot: `https://images.freepik.com/free-photo/landscaping-work-${
          (i % 4) + 1
        }_181624-${90000 + i}.jpg`,
        ...
        detection_time: new Date(),
        description: `${
          landscapingTypes[i % landscapingTypes.length]
        } required in ${parksList[i % parksList.length].park_english_name}`,
        current_status:
          i % 3 === 0 ? "completed" : i % 3 === 1 ? "in_progress" : "pending",
        camera_Id: parkCameras[i % parkCameras.length].Id,
        after_image:
          i % 3 === 0
            ? `https://images.freepik.com/free-photo/completed-landscaping-${
                (i % 3) + 1
              }_181624-${91000 + i}.jpg`
            : null,
      },
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.parks_litter_detection.create({
      data: {
        ...
        occurrence_date: new Date(),
        occurrence_time: new Date(),
        snap_shot: `https://images.freepik.com/free-photo/litter-detection-${
          (i % 3) + 1
        }_181624-${92000 + i}.jpg`,
        ...
        detection_date: new Date(),
        detection_time: new Date(),
        description: `Litter accumulation detected in ${
          parksList[i % parksList.length].park_english_name
        }`,
        current_status:
          i % 3 === 0 ? "cleaned" : i % 3 === 1 ? "cleaning" : "reported",
        camera_Id: parkCameras[i % parkCameras.length].Id,
        after_image:
          i % 3 === 0
            ? `https://images.freepik.com/free-photo/clean-area-${
                (i % 3) + 1
              }_181624-${93000 + i}.jpg`
            : null,
      },
    ...
    await prisma.parks_footfall_analysis.create({
      data: {
        ...
        detected_camera_name:
          parkCameras[i % parkCameras.length].camera_english_name,
        abc1: `Data_${i}`,
        abc2: `Info_${i}`,
        abc3: `Meta_${i}`,
      },
  ...
  for (let i = 0; i < 6; i++) {
    await prisma.offices_footfall_analysis.create({
      data: {
        ...
        detected_camera_name:
          officeCameras[i % officeCameras.length].camera_english_name,
        abc1: `Office_Data_${i}`,
        abc2: `Office_Info_${i}`,
        abc3: `Office_Meta_${i}`,
      },
  ...
  for (let i = 0; i < 3; i++) {
    await prisma.ticket_details_table.create({
      data: {
        ...
        image: `https://images.freepik.com/free-photo/cleaning-progress-${
          (i % 3) + 1
        }_181624-${94000 + i}.jpg`,
  ...
  for (let i = 0; i < 3; i++) {
    await prisma.ticket_details_table.create({
      data: {
        ...
        image: `https://images.freepik.com/free-photo/landscaping-progress-${
          (i % 3) + 1
        }_181624-${95000 + i}.jpg`,
    ...
    await prisma.intranet_posting_history.create({
      data: {
        intrusionDetectionId:
          intrusionDetections[i % intrusionDetections.length].Id,
        title: `Security Alert - Unauthorized Access in ${
          parksList[i % parksList.length].park_english_name
        }`,
