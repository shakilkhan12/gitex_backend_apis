...
import {urlToBase64} from '@services/user.service';

async function uploadAllUsers() {
  const base64 =await urlToBase64("https://192.168.164.7/files/profileimage/Large_96796402520250917131154-Large_561832098120250912172000-usman.jpg");
  console.log("BASE44", base64);
}
