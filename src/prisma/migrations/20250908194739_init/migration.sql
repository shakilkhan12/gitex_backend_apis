...
CREATE TABLE `offices_cameras` (
    ...
    INDEX `office_Id`(`office_Id`),
    UNIQUE INDEX `offices_cameras_office_Id_camera_Id_key`(`office_Id`, `camera_Id`),
    PRIMARY KEY (`Id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `park_cameras` (
    ...
    `updatedAt` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    `location` VARCHAR(255) NULL,
    `attendance` BOOLEAN NULL DEFAULT false,
    `footfall` BOOLEAN NULL DEFAULT false,
    `sentiment` BOOLEAN NULL DEFAULT false,
    `behaviour` BOOLEAN NULL DEFAULT false,
    `irrigation` BOOLEAN NULL DEFAULT false,
    `landscaping` BOOLEAN NULL DEFAULT false,
    `litter_detection` BOOLEAN NULL DEFAULT false,
    `smoking_detection` BOOLEAN NULL DEFAULT false,
    `intrusion` BOOLEAN NULL DEFAULT false,
    `stream_url` VARCHAR(255) NULL,
    `stream_api_key` VARCHAR(255) NULL,
    `stream_path` VARCHAR(255) NULL,
    `password` VARCHAR(255) NULL,
    ...
    UNIQUE INDEX `park_cameras_park_Id_camera_Id_key`(`park_Id`, `camera_Id`),
    PRIMARY KEY (`Id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `park_zones` (
    ...
    INDEX `park_Id`(`park_Id`),
    UNIQUE INDEX `park_zones_park_Id_zone_Id_key`(`park_Id`, `zone_Id`),
    PRIMARY KEY (`Id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
