...
const buildLitterDetectionFilters = (req: Request) => {
   ...
   return {
      ...
      statusFilter: statusFilter as 'unassigned' | 'under_process' | 'completed' | undefined
   };
};
...
class LitterDetectionController extends LitterDetectionService {
   ...
   public static viewLitterDetections = async (req: Request, res: Response, next: NextFunction) => {
      ...
      try {
         ...
         const location = locationParam
            ? (Array.isArray(locationParam) ? locationParam as string[] : [locationParam as string])
            : undefined;
         const statusFilter = req.query.statusFilter as 'unassigned' | 'under_process' | 'completed' | undefined;
   ...
   public static getLitterDetectionFilters = async (req: Request, res: Response, next: NextFunction) => {
      try {
         const startDate = req.query.startDate as string || undefined;
         const endDate = req.query.endDate as string || undefined;
         const result = await LitterDetectionService.getLitterDetectionFiltersService(startDate, endDate);
